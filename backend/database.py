...
def init_db(app):
    ...
    """
    # Prefer MONGODB_URI (Render/Heroku standard) then MONGODB_CONNECT (User provided previously) then Hardcoded Default
    ...
    with app.app_context():
        try:
            ...
            # Don't exit here, let Flask start so we can see error logs in Render
